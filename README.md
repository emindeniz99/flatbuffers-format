...
| [`intellij-flatbuffers/`](./intellij-flatbuffers) | Kotlin (JDK 21) | JetBrains Marketplace: [`io.github.emindeniz99.flatbuffers`](https://plugins.jetbrains.com/plugin/io.github.emindeniz99.flatbuffers) | **JetBrains plugin.** One `.zip` covers IntelliJ IDEA, Rider, WebStorm, PyCharm, GoLand, CLion, RustRover, RubyMine, PhpStorm, Aqua, DataGrip, DataSpell, and Android Studio (all IntelliJ Platform 2024.2+). Hand-rolled lexer for highlighting; shells out to the engine CLI for Reformat Code. |
