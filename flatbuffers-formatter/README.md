...
> the public [`flatbuffers-format`](../flatbuffers-formatter-antlr) package.
...
The cross-check script lives in the sibling and runs in its
...
- [`../flatbuffers-formatter-antlr`](../flatbuffers-formatter-antlr) —
  the published `flatbuffers-format` package, ANTLR-backed.
- [`../flatbuffers-formatter-antlr/test/crosscheck.sh`](../flatbuffers-formatter-antlr/test/crosscheck.sh)
